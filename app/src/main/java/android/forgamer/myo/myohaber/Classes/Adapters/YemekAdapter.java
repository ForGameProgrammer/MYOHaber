...
public class YemekAdapter extends ArrayAdapter<Yemek>
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (row == null)
        {
            ...
            holder.tvYemeklerTarih  = (TextView) row.findViewById(R.id.tvYemeklerTarih);
            holder.tvYemeklerYemek1 = (TextView) row.findViewById(R.id.tvYemeklerYemek1);
            holder.tvYemeklerYemek2 = (TextView) row.findViewById(R.id.tvYemeklerYemek2);
            holder.tvYemeklerYemek3 = (TextView) row.findViewById(R.id.tvYemeklerYemek3);
